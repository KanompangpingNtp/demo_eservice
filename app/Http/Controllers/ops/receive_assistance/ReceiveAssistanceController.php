...
class ReceiveAssistanceController extends Controller
{
    ...
    {
        return view('users.ops.receive_assistance.page-form');
    }
    ...
    public function TableReceiveAssistanceUsersPages()
    {
        ...
        return view('users.ops.receive_assistance.account.show-detail', compact('forms'));
    }
    ...
    public function ReceiveAssistanceUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('users.ops.receive_assistance.pdf-form', compact('form'))
