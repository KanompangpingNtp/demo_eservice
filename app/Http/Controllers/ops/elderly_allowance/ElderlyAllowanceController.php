...
namespace App\Http\Controllers\ops\elderly_allowance;
...
class ElderlyAllowanceController extends Controller
{
    ...
    {
        return view('users.ops.elderly_allowance.page-form');
    }
    ...
    {
        $forms = ElderlyAllowancePeople::with(['user', 'files', 'replies'])->get();

        return view('users.ops.elderly_allowance.account.show-detail', compact('forms'));
    }
    ...
    public function ElderlyAllowanceUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('users.ops.elderly_allowance.pdf-form', compact('form', 'documentType'))
