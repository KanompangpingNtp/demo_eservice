...
class LandBuildingTaxAppealController extends Controller
{
    ...
    public function LandBuildingTaxAppealShowDetails()
    {
        ...
        return view('users.treasury_department.land_building_tax_appeals.account.show-detail', compact('forms'));
    }
    ...
    public function LandBuildingTaxAppealUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('users.treasury_department.land_building_tax_appeals.pdf-form', compact('form'))->setPaper('A4', 'portrait');
