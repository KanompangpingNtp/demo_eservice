...
class LandTaxRefundRequestController extends Controller
{
    ...
    public function LandTaxRefundRequestShowDetails()
    {
        ...
        return view('users.treasury_department.tax_refund_requests.account.show-detail', compact('forms'));
    }
    ...
    public function LandTaxRefundRequestUserExportPDF($id)
    {
        ...
        $pdf = Pdf::loadView('users.treasury_department.tax_refund_requests.pdf-form', compact('form'))->setPaper('A4', 'portrait');
