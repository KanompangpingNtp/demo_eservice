...
<body>
    ...
    <div class="box_text" style="text-align: left; margin-top:1rem;">
        ...
        <span class="dotted-line" style="width: 23.2%; text-align: center; line-height: 1;">{{$file->receipt_book}}</span>
        <span>เลขที่</span>
        <span class="dotted-line" style="width: 23.2%; text-align: center; line-height: 1;">{{$file->receipt_number}}</span>
        <span>ลงวันที่</span>
        <span class="dotted-line" style="width: 23.2%; text-align: center; line-height: 1;">{{DateTimeThai($file->updated_at)}}</span>
        <div style="margin-left:3rem;">
