...
<body>
    ...
    <div class="box_text" style="text-align: left; margin-top:1rem;">
        <div style="margin-left:3rem;">
            <span>(1) เจ้าพนักงานท้องถิ่นอนุญาตให้</span>
        ...
        <span class="dotted-line" style="width: 17%; text-align: center; line-height: 1;"></span>
        <span>โทรสาร</span>
        <span class="dotted-line" style="width: 17.2%; text-align: center; line-height: 1;"></span>
        <div style="margin-left:3rem;">
        ...
        <span class="dotted-line" style="width: 37.5%; text-align: center; line-height: 1;"></span>
        <span>ลงวันที่</span>
        <span class="dotted-line" style="width: 37.5%; text-align: center; line-height: 1;"></span>
        <div style="margin-left:3rem;">
            <span>(2) ผู้รับใบอนุญาตต้องปฎิบัติให้ถูกต้อง ครบถ้วน ตามหลักเกณฑ์ วิธีการ และเงื่อนนไขที่กำหนดในข้อบัญญัติท้องถิ่น</span>
            <span>(3) หากปรากฎในภายหลังว่าการประกอบกิจการที่ได้รับอนุญาตนี้เป็นการขัดต่อกฎหมายอื่นที่เกี่ยวข้องโดยมิอาจแก้ไขได้ </span>
        </div>
        <span>เจ้าพนักงานท้องถิ่นอาจพิจารณาให้เพิกถอนการอนุญาตนี้ได้</span>
        <div style="margin-left:3rem;">
            <span>(4) ผู้รับใบอนุญาตต้องปฎิบัติตามเงื่อนไขเฉพาะดังต่อไปนี้อีกด้วย คือ</span>
            <div style="margin-left:1rem;">
                <span>(4.1) ต้องปฎิบัติตามข้อบัญญัติตำบล เรื่อง ควบคุมสถานที่จำหน่ายอาหารและสถานที่สะสมอาหาร และปฎิบัติตามคำแนะนำ</span>
                <div style="margin-left: -4rem;">
                    ของเจ้าพนักงานสาธารณสุข คำสั่งเจ้าพนักงานท้องถิ่น รวมทั้งระเบียบและกฎหมายอื่นๆ ที่เกี่ยวข้อง
                </div>
                <span>(4.2) มีที่เก็บรวบรวมหรือรองรับขยะมูลฝอยให้ถูกต้องตามหลักสุขาภิบาล</span>
            </div>
        </div>
