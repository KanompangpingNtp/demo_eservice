...
<body>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{route('Index')}}"><img src="{{asset('images/first-pages/logo.png')}}" width="25%"></a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu mb-5">
                    ...
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#public_health2" aria-expanded="false" aria-controls="public_health2">
                            <div class="sb-nav-link-icon">
                                <i class="bi bi-clipboard"></i>
                            </div>
                        ...
                        <div class="collapse" id="public_health2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
