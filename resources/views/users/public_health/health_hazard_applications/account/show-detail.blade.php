    ...
    <table class="table table-bordered table-striped" id="data_table">
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td>{{ $form['details']->name_establishment }}</td>
                <td>
                ...
                <td>
                    ...
                    <a href="{{ route('CertificateHealthHazardPDF', $form->id) }}" class="badge rounded-pill text-bg-success" target="_blank">
                        ออกใบอนุญาต
                    </a>
                ...
                <td>
                    ...
                    <a href="{{ route('HealthHazardApplicationCalendar', $form->id) }}" class="btn btn-primary btn-sm">
                        <i class="bi bi-calendar-check"></i>
                    </a>
                    @endif
                    @if ($form['details']->status == 7)
                    <a href="{{ route('HealthHazardApplicationPayment', $form->id) }}" class="btn btn-primary btn-sm">
                    ...
                    <a href="{{ route('HealthHazardApplicationDetail', $form->id) }}" class="btn btn-success btn-sm">
